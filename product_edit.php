...
<html>
	...
	<body>
    	<!--Header-->
		<header>
			<a href="home.php"><img id="logo" src="img/logo-crown.svg"></a>
			<aside id="admin-account">
            	<h6>Switch to customer view</h6>
				<a href="logout.php" title='logout'><i class="fi-power"></i></a>
			</aside>
		</header>
        <nav class="top-bar">
			<ul class="vertical medium-horizontal menu">
                <li class="user_view_heading"><?php print ucfirst($_SESSION['logged_in_user_access']); ?> View</li>
